...
Per ulteriori dettagli seguire le istruzioni [modifica ruolo amministratore organizzazione](admin-roles.md#add-enterprise-role) nella documentazione dei ruoli amministrativi. Solo un amministratore di sistema dell’organizzazione può assegnare questo ruolo. Per ulteriori informazioni sulla gerarchia amministrativa, consulta la documentazione di [ruoli amministrativi](admin-roles.md).
...
1. Per inviare un caso, selezionare **[!UICONTROL Apri un ticket di supporto]**. Puoi anche selezionare **[!UICONTROL Apri ticket]** nel menu della barra laterale.
   ...
   ![Apri un ticket in Experience League](./assets/open-support-ticket.png)

### Compila il ticket di supporto

Dopo aver selezionato **[!UICONTROL Apri un ticket di supporto]** o **[!UICONTROL Apri ticket]**, viene visualizzata la pagina di creazione del caso.

Il modulo utilizza un flusso di lavoro guidato in più passaggi:

* Seleziona il prodotto Adobe interessato
* Descrivi il problema
* Fornire dettagli di sistema e ambiente
* Indicare l’impatto e l’urgenza
* Conferma le informazioni di contatto
* Rivedi e invia i dettagli
...
1. Fare clic sul nome del prodotto per selezionare il prodotto interessato, quindi fare clic su **[!UICONTROL Avanti]**.
   ...
   ![Experience League ha selezionato un prodotto](./assets/select-product.png)

1. Nella sezione **[!UICONTROL Dettagli problema]**, inserisci il titolo del caso, descrivi il problema e indica i passaggi da riprodurre.

   ![Dettagli problema Experience League](./assets/issue-details.png)

   Includi dettagli quali:

   * Cosa stai cercando di fare
   * Cosa non funziona come previsto
   * Eventuali modifiche recenti dell’ambiente
   * Passaggi già eseguiti

   Quando immetti i dettagli del problema, Experience League mostra i consigli basati sull’intelligenza artificiale in un pannello accanto al modulo. Queste raccomandazioni:
   ...
   * Ridurre la necessità di presentare un caso per problemi comuni
   ...
   Il pannello viene visualizzato senza interrompere il processo di creazione del caso. Puoi rivedere le raccomandazioni in qualsiasi momento e continuare a inviare il caso, se necessario.

   ![Dettagli problema Experience League](./assets/ai-recommendations.png)

1. Fai clic su **[!UICONTROL Avanti]**.

1. Nella sezione **[!UICONTROL Informazioni di sistema]**, selezionare l&#39;ambiente e fare clic su **[!UICONTROL Avanti]**.
   ...
   ![Informazioni sul sistema Experience League](./assets/system-information.png)

1. Nella sezione **[!UICONTROL Impatto]**, seleziona quanto segue:
   * Priorità Caso (P4 - Minore, P3 - Importante, P2 - Urgente, P1 - Critico)
   * Impatto aziendale (piccolo, Medium, grande)

   ![Dettagli sull&#39;impatto di Experience League](./assets/impact.png)
...
1. Nella sezione **[!UICONTROL Informazioni di contatto]**, seleziona il fuso orario, immetti il numero di telefono, aggiungi i controlli, allega eventuali file, se necessario, quindi fai clic su **[!UICONTROL Avanti]**.

   ![Informazioni di contatto Experience League](./assets/contact-information.png)

1. Nella sezione **[!UICONTROL Rivedi e invia]**, controlla i dettagli del caso e fai clic su **[!UICONTROL Invia]**.

   ![Rivedi e invia Experience League](./assets/review-and-submit.png)
