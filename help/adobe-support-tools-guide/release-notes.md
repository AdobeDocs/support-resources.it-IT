...
Queste note sulla versione contengono aggiornamenti al supporto di Experience League e includono:
...
![Nuovo](../adobe-support-tools-guide/assets/new.svg) aggiunto un **[!UICONTROL &quot;Il problema è riproducibile?&quot;Opzione]** per migliorare la risoluzione dei problemi. Se gli utenti selezionano **[!UICONTROL Sì]**, verrà richiesto di fornire i passaggi necessari per riprodurre il problema. Se è selezionato *No*, gli utenti possono procedere con l&#39;invio del caso.
