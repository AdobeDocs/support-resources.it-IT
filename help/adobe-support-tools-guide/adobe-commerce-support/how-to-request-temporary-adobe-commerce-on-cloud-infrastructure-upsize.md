...
Segui questo collegamento per scoprire come [configurare avvisi basati sulle prestazioni](https://experienceleague.adobe.com/it/docs/commerce-on-cloud/user-guide/monitor/new-relic/new-relic-service#monitor-performance-with-managed-alerts).
