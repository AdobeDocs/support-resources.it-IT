...
Quando Adobe termina il supporto di una versione del software Adobe Commerce, è possibile che si verifichino le seguenti condizioni:
...
* Le richieste pull della community non verranno più accettate o unite per la versione EOS. Le estensioni in Commerce Marketplace compatibili solo con versioni di Adobe Commerce non supportate verranno rimosse.
...
Si consiglia vivamente di utilizzare solo software supportato.
...
* Adobe continua a investire in nuove tecnologie e funzionalità. Mantenendo il software aggiornato, è possibile sfruttare le tecnologie e le funzionalità più recenti che consentono alle aziende di operare in modo più strategico e crescere ancora più rapidamente.
...
### Ho una licenza per Adobe Commerce che si estende oltre la data di fine del supporto indicata per tale versione. Adobe continuerà a fornire supporto software per la mia versione non supportata per tutta la durata della mia licenza se scelgo di non passare a una versione supportata?
...
Sì, i ticket di supporto aperti prima della data di fine del supporto di una versione software continueranno a essere utilizzati e risolti anche dopo la data di fine del supporto per tale versione software. Tuttavia, i ticket di supporto per la risoluzione possono dipendere dal fatto che la risoluzione si basi su componenti che non rientrano nel controllo di Adobe Commerce (ad esempio PHP, jQuery, ecc.) scaduti o raggiunti alla fine del supporto. In questi casi, il ticket di supporto può essere risolto richiedendo di eseguire l’aggiornamento alla versione più recente.

### Se apro un ticket per una versione del software per la quale il supporto software scade a breve, Adobe assegnerà la priorità a tali ticket in modo che vengano risolti prima della data di fine del supporto?
