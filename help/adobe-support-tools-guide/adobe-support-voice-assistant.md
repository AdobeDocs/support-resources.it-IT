---
title: Assistenza Adobe Voice Assistant — Assistenza fuori orario e fine settimana (Giappone)
description: L’Assistente vocale per il supporto di Adobe aiuta i clienti in Giappone a ottenere assistenza telefonica in lingua giapponese per gli aggiornamenti dei casi, le escalation urgenti e le richieste di callback.
hold: true
...
# Assistenza Adobe Voice Assistant — Assistenza fuori orario e fine settimana (Giappone)

>[!NOTE]
>
>Questa pagina descrive l’Assistente vocale AI disponibile per il supporto basato su telefono (IVR) in Giappone durante i periodi after-hours e weekend, quando gli agenti live non sono disponibili. Per informazioni generali sull&#39;invio di un caso durante l&#39;orario di lavoro, consulta la [documentazione standard sull&#39;Assistenza clienti di Adobe](/help/adobe-support-tools-guide/adobe-customer-support-experience.md).
>
>
>Il servizio è disponibile solo in Giappone.
...
>[!TIP]
>
>Se il problema causa un’interruzione grave o un impatto aziendale grave, l’assistente può elevare immediatamente la priorità del caso — vedi &quot;Aumentare la priorità del caso a P1&quot; di seguito.

## Funzionalità dell&#39;Assistente vocale

L’Assistente vocale AI supporta le seguenti funzionalità:
...
* Riportare la priorità del caso a P1 quando appropriato
...
L’assistente può condividere gli appunti o i progressi più recenti registrati nel tuo caso, in modo da sapere esattamente cosa è successo finora senza attendere un callback o un’e-mail.
...
L’Assistente vocale AI è in grado di gestire molte esigenze di supporto comuni, ma al momento non è in grado di eseguire alcune operazioni. Per queste situazioni, l&#39;assistente ti guiderà verso un ingegnere umano di supporto.

* **Impossibile accedere ai casi all&#39;esterno dell&#39;account verificato**. Prima che l&#39;assistente possa condividere le informazioni sui casi, è necessario verificare l&#39;identità o i dettagli dei casi

* **Impossibile risolvere problemi tecnici complessi nella chiamata**. L&#39;assistente può raccogliere informazioni e registrarle nel caso, ma la risoluzione dei problemi tecnici è gestita da un tecnico del supporto tecnico

* **Impossibile garantire un tempo di callback immediato**. Le richieste di callback hanno priorità in base alla priorità del caso (ad esempio, i casi P1 vengono gestiti più velocemente), ma i tempi di risposta esatti possono variare

* **Impossibile elaborare una lingua diversa dal giapponese**. L&#39;assistente è progettato specificamente per le conversazioni in lingua giapponese durante questa finestra di servizio fuori orario/fine settimana

* **Impossibile apportare modifiche alla configurazione del prodotto**, ad esempio, modificando le impostazioni nel prodotto o nell&#39;ambiente Adobe

* **Impossibile facilitare il trasferimento delle chiamate a un agente umano**

>[!NOTE]
>
>Per qualsiasi cosa che non rientri nelle funzionalità dell’assistente, verrai indirizzato facilmente a richiedere un callback da un ingegnere del supporto Adobe.
