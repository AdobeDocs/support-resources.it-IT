...
Di seguito sono riportati gli elementi che possono impedire l&#39;ereditarietà degli amministratori di sistema:
   ...
   - Restrizioni relative al tipo di utente (aggiungere i criteri per gli utenti Adobe ID/Enterprise ID/Federated ID). Scopri i [dettagli dei criteri](https://helpx.adobe.com/it/enterprise/global-admin-console/update-policies.html).
...
In qualità di [Amministratore globale](https://helpx.adobe.com/it/enterprise/global-admin-console/manage-administrators.html), puoi aggiungere alla gerarchia delle organizzazioni le organizzazioni esistenti che non fanno attualmente parte della gerarchia di Global Admin Console.
