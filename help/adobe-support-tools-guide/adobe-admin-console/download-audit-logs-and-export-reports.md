...
- I registri disponibili in Global Admin Console includono solo gli eventi a cui un amministratore globale ha accesso. Non includono assegnazioni utente o eventi utente. [Ulteriori informazioni](https://helpx.adobe.com/it/enterprise/using/admin-console.html) sulle diverse funzionalità offerte da ciascuna console.
