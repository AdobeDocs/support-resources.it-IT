...
In qualità di [amministratore globale](https://experienceleague.adobe.com/it/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators), puoi importare dati potenzialmente modificati. Una volta caricati, i nuovi dati vengono confrontati con i dati correnti e le eventuali modifiche vengono applicate alla gerarchia dell’organizzazione. Tutte le operazioni di importazione vengono eseguite sulla copia aggiornata della gerarchia organizzazione. Se sono presenti modifiche in sospeso, le modifiche importate vengono aggiunte alle modifiche in sospeso esistenti nella gerarchia.
...
<tr>
    ...
    <td>
      ...
      Durante l’aggiornamento, si applicano restrizioni significative, tra cui il fatto che il nuovo elemento principale si trovi nella stessa gerarchia e
...
In qualità di [Amministratore globale](https://experienceleague.adobe.com/it/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/manage-administrators), puoi esportare i dati di allocazione prodotto come file JSON o CSV. Puoi quindi modificare questi dati e caricarli per importare le modifiche. Quando vengono caricati i dati potenzialmente modificati, i nuovi dati vengono confrontati con i dati correnti e le eventuali modifiche vengono applicate ai dati di allocazione del prodotto. È quindi possibile rivedere e sottomettere le modifiche in sospeso affinché diventino effettive.
