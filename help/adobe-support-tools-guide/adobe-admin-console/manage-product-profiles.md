...
>[!NOTE]
>
>Per alcuni prodotti, non è possibile creare o modificare i profili di prodotto in Global Admin Console. In questi casi, utilizza [Admin Console](https://experienceleague.adobe.com/it/docs/support-resources/adobe-support-tools-guide/adobe-admin-console/admin-console-overview).
